...
namespace Client.Services
{
    ...
    {
        public void SaveCsv(List<PresentationDTO> ListaPrezentari)
        {
        ...
        public void SaveJson(List<PresentationDTO> ListaPrezentari)
        {
        ...
        public void SaveXml(List<PresentationDTO> ListaPrezentari)
        {
        ...
        public void SaveDoc(List<PresentationDTO> ListaPrezentari)
        {
